...
//API Link
const apiLink: string = "https://v6.exchangerate-api.com/v6/e5c6862d9878d73dae4bade2/latest/PKR"
//Fetch Api Data
let fetchData = async (data: string) => {
    let apiData: any = await fetch(data)
